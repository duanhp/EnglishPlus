...
// (DO NOT EDIT: machine generated header) 'Oracryptuniw.pas' rev: 11.00

#ifndef OracryptuniwHPP
#define OracryptuniwHPP
...
typedef DynamicArray<Byte >  OraCryptUniW__1;

typedef DynamicArray<DynamicArray<Byte > >  TByteArrArr;

typedef DynamicArray<unsigned >  OraCryptUniW__2;
...
typedef DynamicArray<DynamicArray<Byte > >  OraCryptUniW__8;
