...
{$ELSE}
  ...
  DesignIntf, DesignEditors, CRFldLinks, CRValueEdit,
{$ENDIF}
...
{$ENDIF}
  ...
  MemUtils, DBAccess, DAScript, DALoader, DADump,
...
{$ENDIF}
  ...
  TDATableNameEditor = class (TXStringProperty)
  public
    function GetAttributes: TPropertyAttributes; override;
  ...
  TDAUpdatingTableEditor = class (TXStringProperty)
  public
    function GetAttributes: TPropertyAttributes; override;
    procedure GetValues(Proc: TGetXStrProc); override;
  end;

  TDADatabaseNameEditor = class (TXStringProperty)
  public
    function GetAttributes: TPropertyAttributes; override;
    procedure GetValues(Proc: TGetXStrProc); override;
    function AutoFill: boolean; override;
  ...
  TDASPNameEditor = class (TXStringProperty)
  public
    function GetAttributes: TPropertyAttributes; override;
    procedure GetValues(Proc: TGetXStrProc); override;
    function AutoFill: boolean; override;
  ...
  TDAFieldDefsListEditor = class (TXStringProperty) // TDATableOrderFieldsEditor
  public
    function GetAttributes: TPropertyAttributes; override;
    procedure GetValues(Proc: TGetXStrProc); override;
    function AutoFill: boolean; override;
  ...
  TDAFieldsListEditor = class (TXStringProperty) // TDADataSetIndexFieldNamesEditor
  public
    function GetAttributes: TPropertyAttributes; override;
    procedure GetValues(Proc: TGetXStrProc); override;
    function AutoFill: boolean; override;
  ...
  TDALoaderTableNameEditor = class (TXStringProperty)
  public
    function GetAttributes: TPropertyAttributes; override;
    procedure GetValues(Proc: TGetXStrProc); override;
    function AutoFill: boolean; override;
...
{$ENDIF}
  ...
  TDAMetaDataKindEditor = class(TXStringProperty)
  public
    function GetAttributes: TPropertyAttributes; override;
    procedure GetValues(Proc: TGetXStrProc); override;
  end;
...
procedure TDATableNameEditor.GetValues(Proc: TGetXStrProc);
var
  List: _TStringList;
  i: integer;
  Component: TComponent;
...
procedure TDAUpdatingTableEditor.GetValues(Proc: TGetXStrProc);
var
  Component: TComponent;
...
procedure TDADatabaseNameEditor.GetValues(Proc: TGetXStrProc);
var
  List: _TStringList;
  i: integer;
  Component: TComponent;
...
procedure TDASPNameEditor.GetValues(Proc: TGetXStrProc);
var
  List: _TStringList;
  i: integer;
  Component: TComponent;
...
procedure TDAFieldDefsListEditor.GetValues(Proc: TGetXStrProc);
var
  i: integer;
  Component: TComponent;
...
procedure TDAFieldsListEditor.GetValues(Proc: TGetXStrProc);
var
  i: integer;
  Component: TComponent;
  Table: TCustomDADataSet;
...
procedure TDALoaderTableNameEditor.GetValues(Proc: TGetXStrProc);
var
  List: _TStrings;
  i: integer;
  UsedConnection: TCustomDAConnection;
...
var
  ...
  DataSetClass: TCustomDADataSetClass;
begin
  Assert({$IFDEF FPC}PropertyHook{$ELSE}Designer{$ENDIF}.GetComponent(Value) is TCustomDAUpdateSQL);
  UpdateSQL := TCustomDAUpdateSQL({$IFDEF FPC}PropertyHook{$ELSE}Designer{$ENDIF}.GetComponent(Value));
...
procedure TDAMetaDataKindEditor.GetValues(Proc: TGetXStrProc);
var
  List: _TStrings;
  i: integer;
  UsedConnection: TCustomDAConnection;
