...
{$IFDEF FPC}
  LResources,
{$ENDIF}
  Classes, SysUtils, MemUtils, DBAccess,
...
uses
  DASQLComponentEditor, DAQueryEditor, CREditor, DAConsts, DADesignUtils;
...
begin
{$IFDEF DBTOOLS}
  if Editor.DADesignUtilsClass.DBToolsAvailable then begin
    SPName := GetSPName;
