...
{$ENDIF}
  ...
  DBSCHEMA_SQL_TABLE_TYPES: TGUID = '{4E26CDE7-AAA4-41ED-93DD-376E6D409C17}';
  DBSCHEMA_SQL_TABLE_TYPE_PRIMARY_KEYS: TGUID = '{9738FAEA-31E8-4F63-AE0D-613316418CDD}';
  DBSCHEMA_SQL_TABLE_TYPE_COLUMNS: TGUID = '{A663D94B-DDF7-4A7F-A537-D61F12365D7C}';
...
const
  ...
  DBTYPE_DBDATETIMEOFFSET = $00000092; // introduced in SQL 2008
  {$EXTERNALSYM DBTYPE_DBDATETIMEOFFSET}
  DBTYPE_TABLE = $0000008F; // introduced in SQL 2008
  {$EXTERNALSYM DBTYPE_TABLE}
...
// *********************************************************************//
  ...
  DBBINDSTATUS = UINT;
  PDBBINDSTATUSArray = IntPtr;
  TDBBINDSTATUSArray = array of DBBINDSTATUS;
  {$EXTERNALSYM DBBINDSTATUS}
  HWATCHREGION = NativeUInt;
  ...
  DBRESULTFLAG = Integer;
  {$EXTERNALSYM DBRESULTFLAG}
  TISOLEVEL = Integer;
  {$EXTERNALSYM TISOLEVEL}
  DBASYNCHPHASE = DWORD;
  {$EXTERNALSYM DBASYNCHPHASE}
  DBLITERAL = UINT;
  {$EXTERNALSYM DBLITERAL}

  DBACCESSORFLAGS = UINT;
  PDBACCESSORFLAGS = ^UINT;
  {$EXTERNALSYM DBACCESSORFLAGS}

  DBCOUNTITEM = NativeUInt;
  PDBCOUNTITEM = ^DBCOUNTITEM;
  {$EXTERNALSYM DBCOUNTITEM}
  DBLENGTH = NativeUInt;
  {$EXTERNALSYM DBLENGTH}
  DBBYTEOFFSET = NativeUInt;
  {$EXTERNALSYM DBBYTEOFFSET}
  DBROWOFFSET = NativeInt;
  {$EXTERNALSYM DBROWOFFSET}
  DBROWCOUNT = NativeInt;
  {$EXTERNALSYM DBROWCOUNT}
  DBCOMPARE = UINT;
  {$EXTERNALSYM DBCOMPARE}

  DBBKMARK = NativeUInt;
  PDBBKMARKArray = IntPtr;
  TDBBKMARKArray = array of DBBKMARK;
  {$EXTERNALSYM DBBKMARK}

  DBREFCOUNT = UINT;
  PDBREFCOUNT = ^DBREFCOUNT;
  PDBREFCOUNTArray = IntPtr;
  TDBREFCOUNTArray = array of DBREFCOUNT;
  {$EXTERNALSYM DBREFCOUNT}

  DBORDINAL = NativeUInt;
  PDBORDINALArray = IntPtr;
  TDBORDINALArray = array of DBORDINAL;
  {$EXTERNALSYM DBORDINAL}

  DBHASHVALUE = NativeUInt;
  PDBHASHVALUEArray = IntPtr;
  TDBHASHVALUEArray = array of DBHASHVALUE;
  {$EXTERNALSYM DBHASHVALUE}

  DB_UPARAMS = NativeUInt;
  PDB_UPARAMSArray = IntPtr;
  TDB_UPARAMSArray = array of DB_UPARAMS;
  {$EXTERNALSYM DB_UPARAMS}

  DB_LPARAMS = NativeInt;
  PDB_LPARAMSArray = IntPtr;
  TDB_LPARAMSArray = array of DB_LPARAMS;
  {$EXTERNALSYM DB_LPARAMS}
...
const
  ...
  CLSID_SQLNCLI10: TGUID =
    '{8F4A6B68-4F36-4e3c-BE81-BC7CA4E9C45C}';
  CLSID_SQLSERVERCE_3_0: TGUID = '{32CE2952-2585-49a6-AEFF-1732076C2945}';
  CLSID_SQLSERVERCE_3_5: TGUID = '{F49C559D-E9E5-467C-8C18-3326AAE4EBCC}';
  CLSID_SQLSERVERCE_4_0: TGUID = '{2006C53A-C915-41EA-BAA9-9EAB3A1FBF97}';
...
type
  // Copied from sqlncli.h
  SQL_FILESTREAM_DESIRED_ACCESS =
    (SQL_FILESTREAM_READ, SQL_FILESTREAM_WRITE, SQL_FILESTREAM_READWRITE);
...
const
  ...
  SizeOfDBProp = {$IFDEF WIN64}72{$ELSE}52{$ENDIF};
